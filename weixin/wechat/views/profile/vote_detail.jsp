...
<%
	...
	JSONObject info = voteAjax.getVoteJSON(user, voteId, false);
	if(info.isEmpty()){
				...
				<div class="scroll-wrapper">
					<div class="scroll-dom">
						<div class="homework-content">
							...
							<ul class="homework-answer select-data" data-maxnum="<%=sNum %>">
						<%
							...
							%>
								<li class="answer clearfix" id="<%=opValue %>">
									...
									<span class="icon-common icon-radio">
										<input class="selectBox" type="radio" name="radio" />
